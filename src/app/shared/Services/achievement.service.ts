...
export class AchievementService {
  ...
  getUserAchievement(): Observable<ApiResponse<UserLevelDTO>> {
    return this.http
      .get<ApiResponse<UserLevelDTO>>(`${this.urlWellwearApi}/get-user-achievement.php`, { withCredentials: true })
      .pipe(catchError(this.sharedService.handleError));
  }

  getAchievements(): Observable<ApiResponse<AchievementDTO[]>> {
    return this.http
      .get<ApiResponse<AchievementDTO[]>>(`${this.urlWellwearApi}/get-achievements.php`, { withCredentials: true })
      .pipe(catchError(this.sharedService.handleError));
  }

  completeAchievement(achievementId: number): Observable<ApiResponse<UserLevelDTO>> {
    return this.http
      .post<ApiResponse<UserLevelDTO>>(`${this.urlWellwearApi}/complete-achievement.php`, { achievementId }, { withCredentials: true })
      .pipe(catchError(this.sharedService.handleError));
  }
}
